...
The main difference to existing DFA-Tools is
1. The dynamic analysis in an embedded system 
2. Our model includes peripherals common to embedded systems such as DMA, Sensors and UARTs
